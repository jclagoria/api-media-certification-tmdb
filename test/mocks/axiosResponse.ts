...
export const mockMovieCertifications: AxiosResponse = {
  data: {
    certifications: {
      AU: [
        {
      ...
      NO: [
        ...
        },
        {
          certification: '12',
          meaning:
            '12 years (children down to 9 years accompanied by an adult).',
          order: 4,
        },
        {
          certification: 'A',
      ...
      RU: [
        ...
        },
        {
          certification: '12+',
          meaning:
            '(For children above 12) – Unsuitable for children under 12.',
          order: 3,
        },
        {
          certification: 'NR',
      ...
      MX: [
        ...
        },
        {
          certification: 'B',
          meaning:
            'Information-only rating: For adolescents 12 years and older.',
          order: 3,
        },
        {
          certification: 'B-15',
